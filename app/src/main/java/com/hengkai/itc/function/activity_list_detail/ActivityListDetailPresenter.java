 ...
 */
public class ActivityListDetailPresenter extends BasePresenter<ActivityListDetailActivity> {

    private final ActivityListDetailModel model;

    public ActivityListDetailPresenter() {
        model = new ActivityListDetailModel();
    }
